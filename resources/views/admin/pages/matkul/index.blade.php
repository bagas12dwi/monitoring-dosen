                ...
                <div class="row text-sm-start text-center">
                    ...
                    <div class="col-sm-7 col-12 mb-md-0 mb-2">
                        <div class="d-sm-flex justify-content-sm-end">
                            <a href="{{ route('admin.matkul.create') }}" class="btn btn-primary btn-icon-split">
                    ...
                    <table class="my-0 table" id="dataTable">
                        <thead>
                            <tr>
                                ...
                                <th data-col="KODE">KODE MATA KULIAH</th>
                                <th data-col="NAMA">MATA KULIAH</th>
...
@push('scripts')
    <script>
        $(document).ready(function() {
            generateDatatable('dataTable', "{{ route('admin.matkul.data') }}");
        });
    </script>
@endpush
