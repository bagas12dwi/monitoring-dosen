                            ...
                            <div class="row d-flex align-items-center">
                                <div class="col-4">
                                    <div class="card-title fw-bold m-0" style="font-size: 16pt;">
                                        {{ number_format($skorTertinggi['nilai_akhir'], 2) }} %
                                    </div>
                                ...
                                <div class="col-8">
                                    <div class="info-feedback">
                                        <div class="card-title fw-bold m-0" style="font-size: 14pt;">
                                            {{ $skorTertinggi['dosen_nama'] }}
                                        </div>
                                        <span>Skor Dosen Tertinggi</span>
                                    </div>
                    ...
                    <div class="card mb-3">
                        <div class="card-body ">
                            <div class="row d-flex align-items-center">
                                <div class="col-4">
                                    <div class="card-title fw-bold m-0" style="font-size: 16pt;">
                                        {{ number_format($skorTerendah['nilai_akhir'], 2) }} %
                                    </div>
                                </div>
                                <div class="col-8">
                                    ...
                                    <div class="info-feedback">
                                        <div class="card-title fw-bold m-0" style="font-size: 14pt;">
                                            {{ $skorTerendah['dosen_nama'] }}
                                        </div>
                                        <span>Skor Dosen Terendah</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div id="chartCarousel" class="carousel slide" data-bs-interval="false">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <h5>Grafik Tingkat Kepuasan Dosen %</h5>
                                        <canvas id="chart1" height="100"></canvas>
                                    </div>
                                    <div class="carousel-item">
                                        <h5>Grafik Tingkat Kepuasan Dosen PerBulan %</h5>
