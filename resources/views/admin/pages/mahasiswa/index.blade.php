                ...
                <div class="row text-sm-start text-center">
                    ...
                    <div class="col-sm-7 col-12 mb-md-0 mb-2">
                        <div class="d-sm-flex justify-content-sm-end gap-2">
                            <a href="{{ route('admin.mahasiswa.create') }}" class="btn btn-primary btn-icon-split">
                            ...
                            @if (env('APP_DEV'))
                                @include('components.modal-import', [
                                    'title' => 'Mahasiswa',
                                    'route' => route('admin.mahasiswa.import'),
                                ])
                            @endif
                        </div>
                    </div>
                    ...
                    <table class="my-0 table" id="dataTable">
                        <thead>
                            <tr>
                                ...
                                <th data-col="NAMA">NAMA LENGKAP</th>
                                <th data-col="NIM">NIM</th>
                                <th data-col="ANGKATAN">ANGKATAN</th>
...
@push('scripts')
    <script>
        $(document).ready(function() {
            generateDatatable('dataTable', "{{ route('admin.mahasiswa.data') }}");
        });
    </script>
@endpush
