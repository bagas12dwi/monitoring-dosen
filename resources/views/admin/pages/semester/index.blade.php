                ...
                <div class="row text-sm-start text-center">
                    ...
                    <div class="col-sm-7 col-12 mb-md-0 mb-2">
                        <div class="d-sm-flex justify-content-sm-end">
                            <a href="{{ route('admin.semester.create') }}" class="btn btn-primary btn-icon-split">
                    ...
                    <table class="my-0 table" id="dataTable">
                        <thead>
                            <tr>
                                ...
                                <th data-col="TAHUN_AJARAN">TAHUN AJARAN</th>
                                <th data-col="SEMESTER">SEMESTER</th>
                                <th data-col="MULAI" data-type='DATE'>TANGGAL MULAI SEMESTER</th>
                                <th data-col="SELESAI" data-type='DATE'>TANGGAL SELESAI SEMESTER</th>
                                <th data-col="AKTIF" data-type="AKTIF_FLAG">AKTIF</th>
...
@push('scripts')
    <script>
        $(document).ready(function() {
            generateDatatable('dataTable', "{{ route('admin.semester.data') }}");
        });
    </script>
@endpush
