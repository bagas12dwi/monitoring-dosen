                ...
                <div class="row text-sm-start text-center">
                    ...
                    <div class="col-sm-7 col-12 mb-md-0 mb-2">
                        <div class="d-sm-flex justify-content-sm-end">
                            <a href="{{ route('admin.pertanyaan.create') }}" class="btn btn-primary btn-icon-split">
                    ...
                    <table class="my-0 table" id="dataTable">
                        <thead>
                            <tr>
                                ...
                                <th data-col="PERTANYAAN">PERTANYAAN</th>
                                <th data-col="KRITERIA.NAMA">KRITERIA</th>
...
@push('scripts')
    <script>
        $(document).ready(function() {
            generateDatatable('dataTable', "{{ route('admin.pertanyaan.data') }}");
        });
    </script>
@endpush
